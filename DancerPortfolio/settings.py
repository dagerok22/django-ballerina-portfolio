"""
Django settings for DancerPortfolio project.
...
SECRET_KEY = 'nt*nv058t1c7ic0b%d$xv6va!p4tzvizu!)!!6gd+p!06f0d5x'
...
ROOT_URLCONF = 'DancerPortfolio.urls'
...
WSGI_APPLICATION = 'DancerPortfolio.wsgi.application'
